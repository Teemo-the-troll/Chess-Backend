...
public class Game {
    ...
    /**
     * @param source <x,y> original location
     * @param target <x,y> final location
     */
    public void writeMove(Pair<Integer, Integer> source, Pair<Integer, Integer> target) {
    ...
    public void print() {
        ...
        getUser1().print();
        getUser2().print();
        System.out.println(getMoves().get(0).getxSource());
    }
}
